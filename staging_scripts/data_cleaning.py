...
def categorise(row):  
    if row['PROPERTY TYPE RAW']=='Single Family Residential':
        ...
        return 'Townhouse'
    elif row['PROPERTY TYPE RAW']=='Mobile/Manufactured Home' or row['PROPERTY TYPE RAW']=='Ranch' or row['PROPERTY TYPE RAW']=='Timeshare' or row['PROPERTY TYPE RAW']=='Parking':
